...
public class TencentSmsServiceImpl implements TencentSmsService {
     ...
     * 配置方法
     *
     * @param tencentSmsProperties 腾讯云短信属性配置文件
     */
    public void config(TencentSmsProperties tencentSmsProperties) {
        this.tencentSmsProperties = new TencentSmsProperties();
        BeanUtil.copyProperties(tencentSmsProperties, this.tencentSmsProperties, CopyOptions.create().setIgnoreNullValue(true));
        /* 必要步骤：
     ...
     */
    @Override
    public String send(String phone, String templateId, String[] templateParams) {
        try {
            SendSmsRequest req = getSendSmsRequest();
